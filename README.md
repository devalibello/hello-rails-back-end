...
**[Hello-Rails-Back-End]** is a project created using Rails API only approach to provide random greetings in form of API to any frontend devices
...
<details>
<summary>Hello-Rails-Back-End built with Rails API</summary>
  <ul>
...
- **Configured Reck-cors for Usage**
...
[Hello-React-Front-End](https://github.com/devalibello/hello-react-front-end)

### Setup

Clone this repository to your desired folder:

- `git clone https://github.com/devalibello/hello-rails-back-end`
...
Feel free to check the [issues page](https://github.com/Uthmanbello/hello-rails-back-end/issues).
